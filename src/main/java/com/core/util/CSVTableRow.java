...
public class CSVTableRow {
    ...
    public CSVTableRow(String[] data, List<String> headerField) {
        ...
        this.dataArray = new ArrayList<String>(Arrays.asList(data));
        this.headerList = headerField;
    }
    ...
    private Boolean parseBoolean(String string) {
        ...
        if (!isNullString(value)) {
            ...
            if (result == null) {
                    System.err.println("Parameter with value of (" + value + ") could not be converted to a Boolean");
            }
        }
        ...
        if (!isNullString(value)) {
            ...
            if (pos.getIndex() == value.length()) {
                ...
                result = number;
                    ...
                    System.out.println("Parameter with value of (" + value + ") could not be converted to a Number at position " + pos.getIndex());
            }
        }
